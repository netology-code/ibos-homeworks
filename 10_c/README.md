...
**Творческая часть:** попробуйте подобрать данные (по аналогии с лекцией) так, чтобы приложение "упало" (вы получили сообщение segmentation fault или другое, свидетельствующее об ошибке)
...
_Пример:_ Попробуйте ввести специальные символы (например, ;ls /), чтобы проверить, выполнит ли программа произвольные команды. 
